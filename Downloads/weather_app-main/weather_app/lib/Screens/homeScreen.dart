...
import '../widgets/senvenDayForecast.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _getData() async {
    ...
    await weatherData.getWeatherData(context);
    setState(() {
      _isLoading = false;
    });
  }
      ...
      body: SafeArea(
        child: Consumer<WeatherProvider>(
          builder: (context, weatherProv, _) {
            ...
            return Column(
              children: [
                if (_currentPage < 2) searchBar.SearchBar(),
                Center(
                  child: SmoothPageIndicator(       //thanh truot
                    ...
                    : Expanded(
                        child: PageView(
                          ...
                          children: [
                            ...
                            // Third Page of the Page View - Profile Page
                          FadeIn(
                                  curve: Curves.easeIn,
                                  duration: Duration(milliseconds: 250),
                                  child: ProfileScreen(),
